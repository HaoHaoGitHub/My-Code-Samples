...
void StudentTests() {
  ...
  std::cout << "STUDENT TESTS" << std::endl;
    ...
    SanityCheck(t);
    SeparateTestHelper(t, "#STUDENT SEPARATE TEST 3: with six engines");
    ...
    PushBack(t, TrainCar::MakeEngine());
    SanityCheck(t);
    SeparateTestHelper(t, "#STUDENT SEPARATE TEST 1: with three engines");
...
//    PushBack(t, TrainCar::MakeEngine());
//    SanityCheck(t);
//    SeparateTestHelper(t, "#STUDENT SEPARATE TEST 2: with four engines");
//    
//    
//    t = NULL;
//
...
//    PushBack(t, TrainCar::MakePassengerCar());
//    SanityCheck(t);
//    SeparateTestHelper(t, "#STUDENT SEPARATE TEST 4: with eight engines");
//    
//    t = NULL;
//    PushBack(t, TrainCar::MakeEngine());
//    PushBack(t, TrainCar::MakePassengerCar());
...
//    PushBack(t, TrainCar::MakeEngine());
//    SanityCheck(t);
//    SeparateTestHelper(t, "#STUDENT SEPARATE TEST final: with XXXXXX engines");
//    
//    
//    t = NULL;
//    PushBack(t, TrainCar::MakeEngine());
...
//    PushBack(t, TrainCar::MakeEngine());
//    SanityCheck(t);
//    SeparateTestHelper(t, "#STUDENT SEPARATE TEST final: with ~~~~~~~~ engines");
