...
void StudentTests() {
  ...
  std::cout << "STUDENT TESTS" << std::endl;
    ...
    for (int i = 1; i <= 5; i++) {
        std::cout << "============================================================================" << std::endl;
        std::cout << "STUDENT SHIP FREIGHT TEST : maximum number of engines is 5, 20 freight cars of random weight, limit length of 9 cars, and a minimum speed of 70 mph" << std::endl;
        std::cout << "RANDOM SEED #" << i << std::endl;
        ShipFreightHelper(mtrand_autoseed,5,20,70,9);
    }
